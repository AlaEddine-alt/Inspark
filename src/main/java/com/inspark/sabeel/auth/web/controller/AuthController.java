package com.inspark.sabeel.auth.web.controller;

import com.inspark.sabeel.auth.domain.model.AccessToken;
import com.inspark.sabeel.auth.domain.port.input.AuthUseCases;
import com.inspark.sabeel.auth.infrastructure.dto.request.ResetPasswordDto;
import com.inspark.sabeel.auth.infrastructure.dto.request.SignInDto;
...
public class AuthController {
    ...
    public ResponseEntity<AccessToken> signIn(@RequestBody SignInDto user) {
        return new ResponseEntity<>(authUseCases.authenticate(user.email(), user.password()), HttpStatus.OK);
    }
